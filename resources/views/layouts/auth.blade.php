...
<html lang="en">
  <head>
    ...
    @vite(['resources/assets/auth/vendors/mdi/css/materialdesignicons.min.css', 'resources/assets/auth/vendors/css/vendor.bundle.base.css' ,'resources/assets/auth/css/style.css'])
  ...
  <body>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    @vite(['resources/assets/auth/vendors/js/vendor.bundle.base.js', 'resources/assets/auth/vendors/chart.js/Chart.min.js',
    'resources/assets/auth/js/jquery.cookie.js', 'resources/assets/auth/js/off-canvas.js',
    'resources/assets/auth/js/hoverable-collapse.js', 'resources/assets/auth/js/misc.js', 
    'resources/assets/auth/js/dashboard.js', 'resources/assets/auth/js/todolist.js'])
